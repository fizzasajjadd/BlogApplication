...
//read all posts
  ...
  app.put("/posts/:postId", async (req, res) => {
    ...
    try {
      ...
      if(loggedInUser._id.toString() !== updatedPost.author){
        console.log(updatedPost.author, loggedInUser._id);
  ...
  app.delete("/posts/:postId", async (req, res) => {
    ...
    try {
      ...
      if(loggedInUser._id.toString() !== deletedPost.author){
        console.log(loggedInUser._id.toString(),deletedPost.author);
